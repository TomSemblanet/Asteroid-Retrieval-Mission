...
class BrysonMaximumRange(Problem):
    ...
    def path_constraints(self, states, controls, states_add, controls_add, controls_col, f_par):
        ...
        u1 = np.concatenate((controls[0], controls_add[0], controls_col[0]))
        u2 = np.concatenate((controls[1], controls_add[1], controls_col[1]))

        ct_path[0] = u1*u1 + u2*u2
