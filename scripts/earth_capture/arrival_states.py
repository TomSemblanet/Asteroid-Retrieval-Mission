...
def get(file_path):
	...
	return np.concatenate((r_f, v_f)) / 1000, np.concatenate((r_f - r_E, v_f - v_E)) / 1000, np.concatenate((r_f - r_M, v_f - v_M)) / 1000