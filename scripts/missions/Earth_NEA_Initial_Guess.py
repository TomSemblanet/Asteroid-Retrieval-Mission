...
from scripts.missions.Earth_NEA import Earth_NEA
...
# ----------------------------
udp = Earth_NEA_Pos(nea=ast, n_seg=30, tf=(arr_low, arr_upp), \
...
# ----------------------------
udp = Earth_NEA_Vel(nea=ast, n_seg=30, tf=(arr_low, arr_upp), \
	tof=(tof_low, tof_upp), m0=m0, Tmax=Tmax, Isp=Isp, vinf_max=vinf_max, earth_grv=True)
problem = pg.problem(udp)
...
# 9 - Main optimization
# ---------------------
Earth_NEA(year_=nea_dpt_date, x0=x, save=True)
