...
# 		# Computation of the Moon-Moon leg trajectory in the CR3BP frame
...
# 		# Conversion of the moon-moon leg states in the ECI frame
# 		# -------------------------------------------------------
...
# 		ax.plot(moon_moon_trajectory[0], moon_moon_trajectory[1], moon_moon_trajectory[2], '-', color='red', linewidth=1)

# 		plot_env_3D(ax)
# 		plt.show()


# 		# Construction of the Moon-Moon leg thrust intervals
...
if __name__ == '__main__':
	...
	# sum_ = 0
	# for interv in np.vstack((apogee_raising_thrust_intervals, moon_moon_thrust_intervals)):
	# 	sum_ += interv[1] - interv[0]

	# print(moon_moon_thrust_intervals[-1, 1] / 86400)
